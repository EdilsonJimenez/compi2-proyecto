...
_lr_productions = [
  ...
  ('INICIO -> INSTRUCCIONES','INICIO',1,'p_init','Gramatica.py',181),
  ...
  ('INSTRUCCION -> DQL_COMANDOS','INSTRUCCION',1,'p_instruccion','Gramatica.py',204),
  ('DQL_COMANDOS -> SELECT LISTA_CAMPOS FROM NOMBRES_TABLAS CUERPO PUNTOCOMA','DQL_COMANDOS',6,'p_instruccion_dql_comandos','Gramatica.py',215),
  ('DQL_COMANDOS -> SELECT LISTA_CAMPOS FROM NOMBRES_TABLAS PUNTOCOMA','DQL_COMANDOS',5,'p_instruccion_dql_comandosS','Gramatica.py',223),
  ('DQL_COMANDOS -> SELECT DISTINCTNT LISTA_CAMPOS FROM NOMBRES_TABLAS CUERPO PUNTOCOMA','DQL_COMANDOS',7,'p_instruccion_dql_comandosS1','Gramatica.py',230),
  ('DQL_COMANDOS -> SELECT DISTINCTNT LISTA_CAMPOS FROM NOMBRES_TABLAS PUNTOCOMA','DQL_COMANDOS',6,'p_instruccion_dql_comandosS2','Gramatica.py',236),
  ('LISTA_CAMPOS -> LISTA_CAMPOS LISTA','LISTA_CAMPOS',2,'p_ListaCampos_ListaCampos','Gramatica.py',246),
  ('LISTA_CAMPOS -> LISTA','LISTA_CAMPOS',1,'p_ListaCampos_Lista','Gramatica.py',253),
  ('LISTA -> NOMBRE_T PUNTO CAMPOS S','LISTA',4,'p_Lista_NombreS','Gramatica.py',259),
  ('LISTA -> NOMBRE_T PUNTO CAMPOS','LISTA',3,'p_Lista_Nombre','Gramatica.py',267),
  ('LISTA -> CAMPOS S','LISTA',2,'p_Lista_CampoS','Gramatica.py',275),
  ('LISTA -> CAMPOS','LISTA',1,'p_Lista_Campo','Gramatica.py',284),
  ('CAMPOS -> ID','CAMPOS',1,'p_Campos_id','Gramatica.py',292),
  ('CAMPOS -> ASTERISCO','CAMPOS',1,'p_Campos_Asterisco','Gramatica.py',300),
  ('NOMBRE_T -> ID','NOMBRE_T',1,'p_NombreT_id','Gramatica.py',308),
  ('ALIAS -> ID','ALIAS',1,'p_Alias_id','Gramatica.py',316),
  ('S -> COMA LISTA','S',2,'p_S_ComaLista','Gramatica.py',325),
  ('S -> AS ALIAS','S',2,'p_S_AsAlias','Gramatica.py',334),
  ('DISTINCTNT -> DISTINCT','DISTINCTNT',1,'p_Disctint_Rw','Gramatica.py',342),
  ('NOMBRES_TABLAS -> NOMBRES_TABLAS TABLA','NOMBRES_TABLAS',2,'p_NombresTablas_NombresTablas','Gramatica.py',356),
  ('NOMBRES_TABLAS -> TABLA','NOMBRES_TABLAS',1,'p_NombresTablas_Tabla','Gramatica.py',362),
  ('TABLA -> NOMBRE_T','TABLA',1,'p_Tabla_NombreT','Gramatica.py',368),
  ('TABLA -> NOMBRE_T S1','TABLA',2,'p_Tabla_NombreTS','Gramatica.py',376),
  ('S1 -> COMA TABLA','S1',2,'p_Ss_ComaLista','Gramatica.py',385),
  ('S1 -> AS ALIAS','S1',2,'p_Ss_AsAlias','Gramatica.py',394),
  ('CUERPO -> WHERE CONDICIONES','CUERPO',2,'p_Cuerpo_Where','Gramatica.py',405),
  ('CUERPO -> INNERS','CUERPO',1,'p_Cuerpo_Inners','Gramatica.py',412),
  ('CONDICIONES -> CONDICIONES CONDICION','CONDICIONES',2,'p_Condiciones_Lista','Gramatica.py',423),
  ('CONDICIONES -> CONDICION','CONDICIONES',1,'p_Condiciones_Condicion','Gramatica.py',431),
  ('CONDICION -> CONDICION_REL SIMBOLO_LOGICO CONDICION_REL OTRO_LOGICO','CONDICION',4,'p_Condicion_CondicionRel','Gramatica.py',439),
  ('CONDICION -> CONDICION_REL SIMBOLO_LOGICO CONDICION_REL','CONDICION',3,'p_Condicion_CondicionRel_Sin','Gramatica.py',444),
  ('CONDICION -> CONDICION_REL','CONDICION',1,'p_Condicion_CondiRel','Gramatica.py',450),
  ('OTRO_LOGICO -> SIMBOLO_LOGICO CONDICIONES','OTRO_LOGICO',2,'p_OtroLogico_SimboloLogic','Gramatica.py',456),
  ('CONDICION_REL -> EXPRESIONNE OPERADOR EXPRESIONNE','CONDICION_REL',3,'p_CondicionRel_Expresionn','Gramatica.py',463),
  ('INNERS -> INNERS INNERR','INNERS',2,'p_Inners_Lista','Gramatica.py',471),
  ('INNERS -> INNERR','INNERS',1,'p_Inners_Inner','Gramatica.py',479),
  ('INNERR -> INNER JOIN TABLA_REF ON CONDICIONES','INNERR',5,'p_Inner_InnerJoin','Gramatica.py',486),
  ('INNERR -> JOIN TABLA_REF ON CONDICIONES','INNERR',4,'p_Inner_Join','Gramatica.py',493),
  ('INNERR -> WHERE CONDICIONES','INNERR',2,'p_Inner_Where','Gramatica.py',500),
  ('TABLA_REF -> ID','TABLA_REF',1,'p_TablaRef_Id','Gramatica.py',507),
  ('TABLA_REF -> ID AS ID','TABLA_REF',3,'p_TablaRef_IdAS','Gramatica.py',512),
  ('EXPRESIONNE -> NOMBRE_C PUNTO CAMPOSC','EXPRESIONNE',3,'p_Expresion_Nombre','Gramatica.py',520),
  ('EXPRESIONNE -> CAMPOSC','EXPRESIONNE',1,'p_Expresion_CampoC','Gramatica.py',525),
  ('SIMBOLO_LOGICO -> AND','SIMBOLO_LOGICO',1,'p_SimboloLogico_Logicos','Gramatica.py',531),
  ('SIMBOLO_LOGICO -> OR','SIMBOLO_LOGICO',1,'p_SimboloLogico_Logicos','Gramatica.py',532),
  ('NOMBRE_C -> ID','NOMBRE_C',1,'p_NombreC_id','Gramatica.py',538),
